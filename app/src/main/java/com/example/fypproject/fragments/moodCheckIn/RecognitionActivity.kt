...
import com.example.fypproject.mtcnn.FaceDetector
import com.example.fypproject.fragments.moodCheckIn.CameraActivity
import com.example.fypproject.fragments.moodCheckIn.Constants
import com.example.fypproject.fragments.moodCheckIn.EmotionPyTorchVideoClassifier
import com.example.fypproject.fragments.moodCheckIn.LinearSVC
import java.util.*
...
class RecognitionActivity : AppCompatActivity() {
    ...
    /*override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_ACCESS_TYPE) {
            content = data?.data
            val intentNextStep = Intent(this@RecognitionActivity, GalleryActivity::class.java)
    ...
    fun startLive(view: View) {
        val intent = Intent(this@RecognitionActivity, CameraActivity::class.java)
